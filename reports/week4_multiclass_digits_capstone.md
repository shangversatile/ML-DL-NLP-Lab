...
| 14     | `week4/14_week4_final_synthesis_and_transition_to_week5.md` | Week 4 final synthesis and transition to Week 5       |
| 15     | `week4/15_canvas_diagnostic_v1_inventory_and_failure_taxonomy.md` | Canvas-Diagnostic-v1 inventory and failure taxonomy |
...
- [Week 4 Final Synthesis and Transition to Week 5](week4/14_week4_final_synthesis_and_transition_to_week5.md) summarizes the theory-to-system chain, empirical arc, real canvas interpretation, MNIST Option A decision, and Week 5 handoff.
- [Canvas-Diagnostic-v1 Inventory and Failure Taxonomy](week4/15_canvas_diagnostic_v1_inventory_and_failure_taxonomy.md) records the diagnostic-only role, per-class failure taxonomy, Condition-A/Condition-B distinction, and training policy.
- MNIST Option A is selected: Week 4 closes without MNIST implementation, and MNIST/CNN work is deferred to the later deep-learning stage.

Week 4 is ready for final review. It should still not claim production-ready or real-world robust recognition; it now includes a toolchain to collect, evaluate, diagnose, inventory, and responsibly split real canvas evidence.
...
- Final Week 4 review with real canvas sample evidence, dataset protocol, and final synthesis clearly separated from synthetic shift evidence.
...
- [Week 4 Final Synthesis and Transition to Week 5](week4/14_week4_final_synthesis_and_transition_to_week5.md)
- [Canvas-Diagnostic-v1 Inventory and Failure Taxonomy](week4/15_canvas_diagnostic_v1_inventory_and_failure_taxonomy.md)
