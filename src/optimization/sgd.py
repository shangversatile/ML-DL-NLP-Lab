...
class SGD:
    ...
    This optimizer applies a gradient update to the parameters. It can be used
    with gradients computed from one sample, a mini-batch, or the full batch.
    """
    ...
    def step(
        ...
        """Return updated weights and bias using SGD."""
