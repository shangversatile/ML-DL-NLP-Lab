...
| --- | --- | --- | --- | --- | --- |
| Bousquet and Elisseeff, `Stability and Generalization`: <https://www.jmlr.org/papers/v2/bousquet02a.html> | uniform stability definition and stability-generalization theorem | bounded loss, i.i.d. source sampling, remove-one stability, deterministic symmetric learning algorithms, sample-size stability convention | 22, 27, 28 | stability convention, high-probability bound constants, deterministic/symmetric setup for the displayed classical bound | Used only for training-sample perturbation sensitivity; not adversarial or distributional robustness; randomized-algorithm stability uses separate conventions |
